...
def test_nonrecipe_stage_refinement_keeps_grounding_metadata_visible() -> None:
    ...
    refined = refine_nonrecipe_stage_result(
        ...
        grounding_summary={
            "kept_knowledge_row_count": 1,
            "retrieval_gate_rejected_row_count": 0,
            "existing_tag_kept_knowledge_row_count": 1,
            "proposal_candidate_row_count": 0,
            "approved_proposal_candidate_row_count": 0,
            "rejected_proposal_candidate_row_count": 0,
