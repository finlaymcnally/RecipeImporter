...
_FILE_MARKERS: dict[str, tuple[str, ...]] = {
    ...
    "test_benchmark_cutdown_for_external_ai_high_level.py": ("bench",),
    "test_benchmark_cutdown_for_external_ai_starter_pack.py": ("bench",),
    "test_benchmark_cutdown_for_external_ai_upload_bundle.py": ("bench",),
    "test_benchmark_cutdown_for_external_ai_upload_bundle_runtime.py": ("bench",),
    ...
    "test_canonical_line_roles_prompting.py": ("parsing", "llm"),
    "test_canonical_line_roles_recipe_span.py": ("parsing", "llm"),
    "test_canonical_line_roles_runtime.py": ("parsing", "llm"),
    "test_canonical_line_roles_runtime_recovery.py": ("parsing", "llm"),
    "test_canonical_line_roles_taskfile.py": ("parsing", "llm"),
    "test_c3imp_interactive_menu.py": ("cli",),
    "test_c4imp_entrypoint.py": ("cli",),
    "test_bitter_recipe_cli.py": ("cli",),
    "test_bitter_recipe_ledger.py": ("core", "cli"),
    "test_bitter_recipe_workflows.py": ("cli", "labelstudio"),
    ...
    "test_labelstudio_benchmark_helpers_prompt_budget.py": ("labelstudio", "bench", "cli"),
    ...
    "test_quality_suite_runner_parallelism.py": ("bench",),
    "test_quality_suite_runner_race.py": ("bench",),
    "test_quality_suite_runner_resume.py": ("bench",),
    ...
    "test_stats_dashboard_benchmark_semantics.py": ("analytics",),
    "test_stats_dashboard_collectors.py": ("analytics",),
...
_SLOW_FILES = {
    ...
    "test_canonical_line_roles_codex.py",
    "test_canonical_line_roles_prompting.py",
    "test_canonical_line_roles_recipe_span.py",
    "test_canonical_line_roles_runtime.py",
    "test_canonical_line_roles_runtime_recovery.py",
    "test_canonical_line_roles_taskfile.py",
    "test_labelstudio_benchmark_helpers_eval_payload_artifacts.py",
    "test_labelstudio_benchmark_helpers_eval_payload_compare.py",
    "test_labelstudio_benchmark_helpers_eval_payload_execution.py",
    "test_labelstudio_benchmark_helpers_eval_payload_pipelined.py",
