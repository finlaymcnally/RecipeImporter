...
- Generated at: `2026-03-03_21.48.23`
- Source folder: `/home/mcnal/projects/recipeimport/tmp/profeedback_audit_bundle`
- Bundle folder: `/home/mcnal/projects/recipeimport/tmp/profeedback_audit_bundle`
...
- full_prompt_log_rows: 51

## Self-Check

- starter_pack_present: true
- starter_pack_physical_dir_present: true
...
|---|---|---|---|---|---|
| codexfarm | complete | written | written | written | written |
| vanilla | not_applicable | missing | missing | written | not_applicable |
