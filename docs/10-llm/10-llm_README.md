...
- the old `knowledge_phase_workspace_tools.py` lease/packet helper surface has been removed. The normal paved road is: open `task.json`, edit only the answer fields, save, and stop.
