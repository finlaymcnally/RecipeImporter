---
summary: "ExecPlan for integrating structured ingredient parsing using Ingredient Parser."
read_when:
...
- [x] (2026-01-21 22:45Z) Add Ingredient Parser to pyproject.toml dependencies.
...
- Decision: Use Ingredient Parser library for NLP-based parsing.
...
The Ingredient Parser library (https://github.com/strangetom/ingredient-parser, https://ingredient-parser.readthedocs.io/en/latest/) provides a parse_ingredient() function that returns a ParsedIngredient dataclass with these fields:
...
The Ingredient Parser library is already installed. Verify with:
