...
2026-02-24_22.47.11_recipeimport-docs-summary.md - [missing front matter]
...
plans/add-tags.md - ExecPlan for optional codex-farm pass5 tag suggestions with stage integration.
  Read when: "When implementing or maintaining pass5 recipe tag suggestions"; "When reconciling deterministic tagging with optional codex-farm tagging"
plans/bench-refactor.md - [missing front matter]
plans/combine-knowledge-chunks.md - ExecPlan for adjacent same-topic knowledge chunk consolidation, including table-aware no-merge guardrails.
  Read when: "When changing knowledge chunk consolidation behavior in cookimport/parsing/chunks.py"
...
plans/knowledge-tables.md - ExecPlan for deterministic non-recipe table extraction, table-aware chunking, and optional pass4 table hints.
  Read when: "When implementing or auditing knowledge-table extraction behavior"
plans/Sub-grouping-recipe-steps.md - [missing front matter]
...
understandings/2026-02-25_16.21.30-table-extraction-stage-pass4-wiring.md - Where table extraction must be wired so chunking, staged outputs, and pass4 bundles stay aligned.
  Read when: "When changing deterministic table extraction behavior"; "When pass4 table hints or chunk boundaries look wrong"
understandings/2026-02-25_16.24.24-pass5-stage-tagging-wiring.md - How pass5 tag suggestions plug into stage output flow and run settings.
  Read when: "When debugging why stage did or did not write `tags/` artifacts"; "When changing llm_tags_pipeline, pass5 pipeline ids, or tag catalog path wiring"
understandings/2026-02-25_16.39.07-chunk-consolidation-absolute-adjacency-and-table-guard.md - Why chunk consolidation uses provenance absolute ranges and why table chunks are excluded from all merges.
  Read when: "When changing knowledge chunk merge/consolidation logic"; "When pass4 bundle block index mapping appears to conflict with chunk adjacency checks"
understandings/2026-02-25_16.42.42-step-linking-section-context-and-duplicate-indexing.md - How section-aware step linking works and why ingredient identity must be index-based for duplicate lines.
  Read when: "When repeated ingredient names map to the wrong instruction step"; "When changing section-aware behavior in `cookimport/parsing/step_ingredients.py`"
...
## docs/plans/Sub-grouping-recipe-steps.md
...
## docs/plans/combine-knowledge-chunks.md
...
## docs/plans/knowledge-tables.md
