...
* `YYYY-MM-DD_HHMM - short-title.md`
  * Example: `2026-01-21_1430 - add save slot ui.md`
...
* **Tracking link**: the `/tasks/...` file that acts as the single context anchor
...
* **Anchor to a task file.** Link the `/tasks/...` file that states what “done” means and how to verify it.
...
* **Short and factual.**
* One-line summary + link/path to the task file (e.g., `Refs: /tasks/...`).
* No implementation essay.

**Suggested format**

* `Imperative summary`
  `Refs: /tasks/2026-01-21_1430 - short-title.md`
...
If you want, paste your existing `/tasks/...` template (if you have one) and I’ll align the “Must include” section to match it without bloating anything.
