...
- carries the recipe row-ownership contract forward and may only shrink ownership through explicit divestment recorded in `recipe_authority/<workbook_slug>/recipe_row_ownership.json`
