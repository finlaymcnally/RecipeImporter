...
Shard-v1 recipe, knowledge, and line-role now all run one direct `codex exec --json --output-schema ... -` call per shard with the full shard prompt sent once on stdin.
