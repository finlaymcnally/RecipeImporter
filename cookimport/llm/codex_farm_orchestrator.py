...
LEGACY_SINGLE_CORRECTION_RECIPE_PIPELINE_IDS = frozenset(
    {
...
def _normalized_recipe_pipeline_value(value: str | None) -> str:
    normalized = str(value or "").strip().lower()
    if normalized in LEGACY_SINGLE_CORRECTION_RECIPE_PIPELINE_IDS:
        return SINGLE_CORRECTION_RECIPE_PIPELINE_ID
    return normalized
...
def _build_single_correction_manifest(
    *,
    ...
    return {
        "enabled": True,
        "pipeline": SINGLE_CORRECTION_RECIPE_PIPELINE_ID,
        "pipeline_aliases_accepted": sorted(LEGACY_SINGLE_CORRECTION_RECIPE_PIPELINE_IDS),
