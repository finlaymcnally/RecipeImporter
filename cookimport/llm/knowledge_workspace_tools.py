...
def render_current_task_brief_text(
    *,
    ...
    lines = [
        ...
        "Large block-index jumps or abrupt topic changes are a cue that nearby packet rows may be unrelated; classify block-locally and only group when the text itself clearly matches.",
        "",
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "- Packet order is preserved, but packet adjacency is not semantic proof. Large owned-block index jumps can mean unrelated source regions were packed together.",
            "",
            "Per idea group:",
            ...
            "- Do not merge blocks into one idea group just because they are adjacent in the task file; require clear topical continuity in the text itself.",
            "",
            "Utility questions:",
