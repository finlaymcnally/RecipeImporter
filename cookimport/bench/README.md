...
- Canonical-text eval can choose SequenceMatcher implementation via `COOKIMPORT_BENCHMARK_SEQUENCE_MATCHER` (`auto`, `stdlib`, `cydifflib`, `cdifflib`); evaluator telemetry records the selected implementation.
