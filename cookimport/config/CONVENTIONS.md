...
- `llm_recipe_pipeline` accepts `off|codex-farm-single-correction-v1` without environment gating; validation should reject removed recipe pipeline ids instead of normalizing them.
