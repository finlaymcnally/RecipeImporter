...
LINE_ROLE_CODEX_PIPELINE = LINE_ROLE_PIPELINE_ROUTE_V2
LINE_ROLE_DETERMINISTIC_PIPELINE = "deterministic-route-v2"
KNOWLEDGE_CODEX_PIPELINE = KNOWLEDGE_CODEX_PIPELINE_CANDIDATE_V2
