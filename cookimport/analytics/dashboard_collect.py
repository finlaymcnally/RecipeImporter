...
* ``data/golden/**/eval_report.json`` (benchmark scan path for explicit opt-in)
"""
...
from .benchmark_manifest_runtime import (
    ...
    extract_codex_runtime_error_from_manifest as _extract_codex_runtime_error_from_manifest,
...
def _benchmark_report_metric_value(
    ...
    if metric_name == "macro_f1_excluding_other":
        return _safe_float(report.get("macro_f1_excluding_other"))
