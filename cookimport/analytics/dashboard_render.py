...
(function () {
  ...
  function renderBenchmarkTrendChart() {
    ...
    const strictPrecision = benchmarkSeriesFromRecords(sorted, "precision");
    const strictRecall = benchmarkSeriesFromRecords(sorted, "recall");
    const strictF1 = benchmarkSeriesFromRecords(sorted, "f1");
    const practicalF1 = benchmarkSeriesFromRecords(sorted, "practical_f1");
    const pointCount = Math.max(
      strictPrecision.length,
      strictRecall.length,
      strictF1.length,
      practicalF1.length,
    );
