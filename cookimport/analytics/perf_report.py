...
from .benchmark_manifest_runtime import (
    TOKEN_USAGE_KEYS as _TOKEN_USAGE_KEYS,
    clean_runtime_text as _clean_runtime_text,
    default_codex_reasoning_effort_for_model as _default_codex_reasoning_effort_for_model,
    explicit_runtime_from_run_config as _explicit_runtime_from_run_config,
    extract_codex_runtime_from_manifest as _extract_codex_runtime_from_manifest,
    extract_codex_token_usage_from_manifest as _extract_codex_token_usage_from_manifest,
    extract_line_role_token_usage_from_manifest as _extract_line_role_token_usage_from_manifest,
    merge_missing_run_config_fields as _merge_missing_run_config_fields,
    nonnegative_int_or_none as _nonnegative_int_or_none,
    parse_int_or_none as _parse_int_or_none,
    runtime_from_run_config as _runtime_from_run_config,
    sum_token_usage as _sum_token_usage,
    token_usage_has_values as _token_usage_has_values,
)
...
def _load_manifest_backfill_context(
    ...
    if (
        _clean_runtime_text(manifest_effort, treat_default_missing=True) is None
        and manifest_model is not None
    ):
        manifest_effort = _default_codex_reasoning_effort_for_model(manifest_model)
    (
        token_input,
        token_cached_input,
        token_output,
